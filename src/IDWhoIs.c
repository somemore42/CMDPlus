...
"421321","湖北省随州市随县",
"421381","湖北省随州市广水市",
"422800","湖北省恩施土家族苗族自治州恩施土家族苗族自治州",
...
"431381","湖南省娄底市冷水江市",
"431382","湖南省娄底市涟源市",
"433100","湖南省湘西土家族苗族自治州湘西土家族苗族自治州",
...
"450181","广西壮族自治区南宁市横州市",
"450200","广西壮族自治区柳州市柳州市",
...
"451000","广西壮族自治区百色市百色市",
"451002","广西壮族自治区百色市右江区",
"451003","广西壮族自治区百色市田阳区",
...
"513400","四川省凉山彝族自治州凉山彝族自治州",
"513401","四川省凉山彝族自治州西昌市",
"513402","四川省凉山彝族自治州会理市",
...
"522600","贵州省黔东南苗族侗族自治州黔东南苗族侗族自治州",
...
"522700","贵州省黔南布依族苗族自治州黔南布依族苗族自治州",
...
"532300","云南省楚雄彝族自治州楚雄彝族自治州",
"532301","云南省楚雄彝族自治州楚雄市",
"532302","云南省楚雄彝族自治州禄丰市",
...
"532500","云南省红河哈尼族彝族自治州红河哈尼族彝族自治州",
...
"640000","宁夏回族自治区宁夏回族自治区宁夏回族自治区",
"640100","宁夏回族自治区银川市银川市",
...
"652900","新疆维吾尔自治区阿克苏地区阿克苏地区",
"652901","新疆维吾尔自治区阿克苏地区阿克苏市",
"652902","新疆维吾尔自治区阿克苏地区库车市",
...
"654000","新疆维吾尔自治区伊犁哈萨克自治州伊犁哈萨克自治州",
...
const int LOCATIONCODESIZE=3211;
void info_Find_Top(char url[]){
	char LocationCode[7]="";
	//省级搜索
	LocationCode[0]= url[0];
	LocationCode[1]= url[1];
	for (int i = 2; i < 6; i++) {
		LocationCode[i]= '0';
	}
	LocationCode[6]='\0';
	...
	int isFind=0;
	char *s=0;
	while(p<LOCATIONCODESIZE){
		s=(char*)LOCATION[2*p];
		if(streqa(LocationCode,s)){
		isFind=1;
		break;
		}
		p++;
	}
	if(isFind){isFind=0;printf("（%s）", LOCATION[p*2+1]);}
	//市级搜索
	LocationCode[0]= url[0];
	LocationCode[1]= url[1];
	LocationCode[2]= url[2];
	LocationCode[3]= url[3];
	for (int i = 4; i < 6; i++) {
		LocationCode[i]= '0';
	}
	LocationCode[6]='\0';
...
void info(char url[]) {
	...
	printf("年龄：%d周岁 ",age);
	if(p>=LOCATIONCODESIZE){printf("户籍代码未知：%s ", LocationCode );info_Find_Top(url);}
	else{printf("户籍：%s \n", LOCATION[p*2+1]);}
...
int main() {
	...
	char rX = '\0';
	int code = 0;
	printf("中华人民共和国身份证号码校验程序v3.0 Copyright 2020-%d MDS, All Rights Reserved.\n仅适用于第二代身份证，户籍结果以2024年行政区规划为准。\n\n", nowYear());
	while (1) {
		printf("输入待检验的身份证号码：>");
		scanf("%s", &id);
